...
def swipe_xargs(query_file, db_file, name, matrix, gapopen, gapextension, num_threads, min_score, chunk_s):
...
def main():
    ...
    swipe_xargs(query_file, db_file, name, args.matrix, args.gapopen, args.gapextension, args.num_threads, args.min_score, args.chunksize)
